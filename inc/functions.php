 ...
 * @return void
 */
function redirect_with_message_post(string $message, string $type=FLASH_ERROR, string $name='upload', string $location='post.php'): void
{
...
function redirect_with_message_index(string $message, string $type=FLASH_ERROR, string $name='edit', string $location='index.php'): void
{
    flash($name, $message, $type);
    header("Location: $location", true, 303);
    exit;
